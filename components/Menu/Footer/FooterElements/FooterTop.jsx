        ...
        <BasicContainer>
          <div className='grid grid-row grid-cols-1 xl:grid-cols-3 justify-between items-center text-white'>
            ...
            <span className='xl:col-span-1 hidden xl:flex flex-row justify-between px-16 2xl:px-24'>
              <Link href={'https://www.facebook.com/exclusiveoffmarketdeal'} target={'_blank'}>
                {Facebook ? (
                  <Image
                    src={Facebook}
                    alt='Facebook Icon'
              ...
              <Link href={'https://www.instagram.com/exclusiveoffmarketdeal/'} target={'_blank'}>
                {Instagram ? (
                  <Image
                    src={Instagram}
                    alt='Instagram Icon'
              ...
              <Link href={'https://www.linkedin.com/exclusiveoffmarketdeal'} target={'_blank'}>
                {Linkedin ? (
                  <Image
                    src={Linkedin}
                    alt='Linkedin Icon'
            ...
            <span className='xl:col-span-1 flex flex-row justify-between xl:justify-end font-light text-sm mb-6 xl:mb-0'>
              <div className='flex flex-col text-right'>
                <Link className='hover:text-vb_green-400 mb-2 transition-all duration-150 ease-in-out' href='/login'>
                  Log In
                </Link>
              </div>
              <div className='flex flex-col text-right ml-16'>
                <Link className='hover:text-vb_green-400 mb-2 transition-all duration-150 ease-in-out' href='/signup'>
                  Sign Up
                </Link>
              </div>
            </span>
            <span className='col-span-1 xl:hidden flex flex-row justify-between w-64 md:w-1/2 mx-auto'>
              ...
              <Link href={'https://twitter.com/exclusiveoffmarketdeal'} target={'_blank'}>
                {Twitter ? (
                  <Image
                    src={Twitter}
                    alt='Twitter Icon'
