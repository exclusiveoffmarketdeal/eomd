        ...
        <BasicContainer>
          <div className='py-8'>
            <p className='text-white text-center text-xl leading-relaxed tracking-wider'>
              At Exclusive Off Market Dealswe are always looking for ways to ensure our residents have a seamless move
              in process. The following is a list of Utility Providers that we have compiled to help our residents find
              the resources they may need to help them during move in. We do not endorse or provide any advice which
              services are best to work with or might be right for any individual situation. If you see a listing on
              this page that is no longer valuable or if you have a resources that is not listed here that you think
